        ...
        <header id="header" class="flex justify-between items-center h-20 px-4">
            ...
            <div class="flex">
                <div class="flex justify-center items-center h-12 px-2 border border-gray-200 rounded transition focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-brand" aria-label="My Profile">
                    ...
                    <div class="text-xs cursor-default line-clamp-1" style="max-width: 128px;">حسین نخلی</div>
                </div>
                <a href="{{ route('logout') }}" class="flex justify-center items-center w-12 h-12 text-gray-600 hover:text-brand border border-gray-200 hover:border-brand rounded transition ms-2 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-brand" aria-label="Notifications">
