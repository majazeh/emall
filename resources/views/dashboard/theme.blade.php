...
@section('body')
    <aside id="aside" class="bg-gray-50 border-e border-gray-200 z-50 transition ease-in-out overflow-y-auto">
        ...
        <ul class="px-2">
            ...
            <li class="mb-1">
                <a {{-- href="{{ route('dashboard.banners.index') }}" data-metarget="banners" data-metarget-pattern="/dashboard/banners.*" --}} class="flex items-center py-4 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
