...
@section('body')
    <aside id="aside" class="hidden lg:block fixed inset-y-0 -start-64 lg:start-0 w-64 h-screen bg-gray-50 border-e border-gray-200 z-50 transition ease-in-out overflow-y-auto">
        ...
        <ul class="px-2">
            <li class="mb-1">
                <a href="{{ route('dashboard') }}" class="flex items-center py-4 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
            ...
            <li class="mb-1">
                <a href="{{ route('dashboard.users.index') }}" class="flex items-center py-4 px-6 rounded bg-brand text-white transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="mb-1">
                <a href="{{ route('dashboard.categories.index') }}" class="flex items-center py-4 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    ...
                    <span class="font-bold">@lang('Categories')</span>
                </a>
            </li>
        </ul>
    </aside>
