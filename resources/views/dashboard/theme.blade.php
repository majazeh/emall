...
@section('body')
    <aside id="aside" class="bg-gray-50 border-e border-gray-200 z-50 transition ease-in-out overflow-y-auto">
        ...
        <ul class="px-2">
            ...
            <li>
                <a href="#" {{-- data-metarget="banners" data-metarget-pattern="/dashboard/banners.*" --}} class="flex items-center py-4 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2m-4-1v8m0 0l3-3m-3 3L9 8m-5 5h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293h3.172a1 1 0 00.707-.293l2.414-2.414a1 1 0 01.707-.293H20" />
                    </svg>
                    <span class="font-semibold">@lang('Requested Products')</span>
                </a>
            </li>
        </ul>
    </aside>
