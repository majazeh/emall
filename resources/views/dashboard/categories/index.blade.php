...
<div class="mb-4 flex items-center">
    ...
    {{-- <span class="text-sm text-gray-400 ms-2">({{ $categories->total() }})</span> --}}
</div>
                            ...
                            <tr class="transition hover:bg-gray-50">
                                ...
                                <td class="px-3 py-4 whitespace-nowrap">
                                    <div class="flex items-center cursor-default">
                                        ...
                                        <span class="text-sm text-gray-600">الحلیب</span>
                                    </div>
                                </td>
                                <td class="px-3 py-4 whitespace-nowrap">
                                    <div class="flex items-center cursor-default">
                                        {{-- <span class="text-sm text-gray-600">{{ $category->parent }}</span> --}}
                                        <span class="text-sm text-gray-600">ألبان</span>
                                    </div>
                                </td>
                                <td class="px-3 py-4 whitespace-nowrap">
                                    <div class="flex items-center cursor-default">
