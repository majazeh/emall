        ...
        <div class="flex items-center justify-center">
            <div class="rounded w-full sm:w-80 mx-4 sm:mx-auto relative top-20">
                ...
                <form action="">
                    ...
                    <button type="button" class="flex items-center justify-center w-full mb-2 sm:mb-0 h-10 px-4 text-sm bg-brand text-white rounded-full hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-opacity-60 focus:ring-brand transition mt-4">استمر</button>
                </form>
            </div>
        </div>
    </div>
