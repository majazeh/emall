            ...
            <div class="rounded w-full sm:w-80 mx-4 sm:mx-auto relative top-20">
                ...
                <div data-xhr="form">
                    <form action="#" method="POST">
                        <input type="text" disabled value="" class="w-full text-sm text-left dir-ltr text-gray-400 border border-gray-200 rounded h-10 px-3 mb-2 bg-gray-100" id="authorized_key" name="authorized_key">
