    ...
    <main data-xhr="main">
        <section class="my-4 px-4">
            <div class="flex border border-gray-300 rounded overflow-hidden h-24 mb-4">
                <a href="#" class="w-24 h-24 flex-shrink-0">
                    <img src="https://emall.market/storage/products/456cfbb142ce05fea92a541cec9334d4-250.jpg" alt="ماكنة حلاقة شفرتين" width="96" height="96">
                </a>
                <div class="flex-1 flex flex-col justify-center px-2 cursor-default">
                    ...
                    <div class="flex items-center mt-2 text-gray-700">
                        ...
                        <span class="text-sm font-bold mx-2">1</span>
