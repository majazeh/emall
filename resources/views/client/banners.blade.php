<div class="flex flex-col items-center justify-center relative">
    <div class="w-full bg-white rounded overflow-x-hidden flex snap-x" style="height: 32vh">
        @foreach ($intro->banners ? $intro->banners : [] as $item)
            <a href="{{ $item->url }}" class="direct emall_slider snap-start w-full h-full flex items-center justify-center text-white text-4xl font-bold flex-shrink-0 bg-brand" id="slide-{{ $loop->index +1 }}">
